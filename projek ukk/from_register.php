...
<form action="login.php"  method="POST">
        ...
        <div class="mb-3">
            <label>Nama :</label><br>
            <input type="text" name="nama_petugas" placeholder="Isi Nama anda">
        </div>
        <div class="mb-3">
            <label>Username :</label><br>
            <input type="text" name="username" placeholder="Isi usename anda">
        </div>
        <div class="mb-3">
            <label>Password:</label><br>
            <input type="text" name="password" placeholder="Isi password anda">
        </div>
        <div class="mb-3">
            <label>No telp:</label><br>
            <input type="text" name="telp" placeholder="Isi no telp anda">
        </div>
        <div class="mb-3">
            <label>Level :</label><br>
            <input type="text" name="level" placeholder="Isi level anda">
        </div>
