...
<div style="padding: 10px;">
        <form action="proses_pengaduan.php"  method="POST" entype="multipart/from-data">
        ...
        <div class="card my-6">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3 text-center mt-3 ">
                tanggal pengaduan : 
                <input class="rounded-3 form-control" type="text" value="<?php  echo date('d/m/y')?>" name="tgl_pengaduan" style="width: 400px;margin:auto" readonly>
               </div>
              <div class="mb-3 text-center mt-3 ">
                Isi_laporan: 
