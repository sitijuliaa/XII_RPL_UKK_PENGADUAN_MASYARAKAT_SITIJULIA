...
<div style="padding: 10px;">
        <form action="proses_update.php?id_pengaduan=<?=$id?>"  method="POST" enctype='multipart/form-data'>
        <div class="container mt-2">
        <div class="row" >
        <div class="col-md-8 offset-md-1" style="margin:auto">
        <div class="card my-6">
           
            <h2 class="mb-3 mt-4 text-center" style="color:rgb(61, 61, 61);">isi pengaduan</h2>
            <div class="container mt-2">
            <div class="mb-3">
              <div>
