...
<body style="background:grey;">
    ...
    <h1 class="text-black">petugas</h1>
  ...
  <div class="card-header">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="tanggapan.php">tanggapi</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  ...
  <tbody>
    ...
    <td>
    <a href="data_pengaduan.php?id_pengaduan=<?=$row['id_pengaduan'];?>" class="btn btn-sm btn-success ml-auto">tanggapi</a>
    </td>
    <?php endwhile ?>
    </tbody>
    <?php $i++; ?>
